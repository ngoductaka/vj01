...
class BlockService {
  ...
  constructor() {
    ...
    this.shapes = [
      require('../../../screen/GameCenter/NewTetris/shapes/BarShape'),
      require('../../../screen/GameCenter/NewTetris/shapes/InverseLShape'),
      require('../../../screen/GameCenter/NewTetris/shapes/InverseZShape'),
      require('../../../screen/GameCenter/NewTetris/shapes/LShape'),
      require('../../../screen/GameCenter/NewTetris/shapes/SquareShape'),
      require('../../../screen/GameCenter/NewTetris/shapes/TriangleShape'),
      require('../../../screen/GameCenter/NewTetris/shapes/ZShape')
    ];
  }
