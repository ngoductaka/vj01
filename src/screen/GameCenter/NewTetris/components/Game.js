...
import { STATE_PLAY, STATE_INSTRUCTION, STATE_BEST_SCORE, STATE_SET_SCORE } from '../../../../redux/reducers/tetris/workflow'
...
const Game = (props) => (
    <View style={styles.game} >
        ...
        { props.wfState === STATE_INSTRUCTION && <Scores points={props.points} level={props.level} lineNumberBeforeNextLevel={props.lineNumberBeforeNextLevel} />}
