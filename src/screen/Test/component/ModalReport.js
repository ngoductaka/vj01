...
export const FeedbackModal = ({ data }) => {
    ...
    const _handleSubmit = () => {
        // console.log('asdfasfasd', err, des);
    ...
    return (
        <View>
            <TouchableOpacity
                ...
                style={{ paddingHorizontal: 20, flexDirection: 'row', alignItems: 'flex-end', paddingVertical: 5 }}>
            ...
            >
                <View style={{ paddingTop: 30, paddingHorizontal: 20, paddingBottom: 20, marginBottom: getBottomSpace() }}>
                    <Text style={{ ...fontMaker({ weight: fontStyles.Bold, }), fontSize: 18 }}>Báo cáo lỗi câu hỏi</Text>
                    {/* <Text style={{ ...fontMaker({ weight: fontStyles.Regular, }), fontSize: 16, marginVertical: 10 }}>Bạn gặp lỗi gì với câu hỏi này?</Text> */}
