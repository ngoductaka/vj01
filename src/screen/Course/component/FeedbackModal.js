...
export const FeedbackModal = (props) => {
    const { data, show = false, onClose = () => { }, showCancel = true, setCurrentClass = () => { }, isShowMore = false } = props;
    ...
    return (
        ...
        >
            <View style={{ paddingTop: 30, paddingHorizontal: 20, paddingBottom: 20, marginBottom: getBottomSpace() }}>
                <Text style={{ ...fontMaker({ weight: fontStyles.Bold, }), fontSize: 18 }}>Báo cáo lỗi video?</Text>
                {/* <Text style={{ ...fontMaker({ weight: fontStyles.Regular, }), fontSize: 16, marginVertical: 10 }}>Báo cáo lỗi video?</Text> */}
                ...
                <Text
                    style={{
                        ...
                        fontSize: 16, color: COLOR.MAIN, marginBottom: 10,
                        marginTop: 20
                    }}>Chi tiết lỗi</Text>
                {desInput}
