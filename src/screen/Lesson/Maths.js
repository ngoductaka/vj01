	...
	render() {
		return (
			<View style={styles.container}>
				<MathJax
					html={`<p> <b>1. Định nghĩa: </b> Căn bậc ba của một số a, kí hiệu là <img src="https://vietjack.com/toan-lop-9/images/can-bac-ba.PNG" style="margin: 0 10px"> là số x sao cho $x^3 = a.$ </p>`}
